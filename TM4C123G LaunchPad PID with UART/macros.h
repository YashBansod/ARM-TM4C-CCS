...
#define K_I             8                           // Macro for SumError Multiplication by 1/2^N
#define K_D             9                           // Macro for Error Difference Multiplication by 1/2^N
#define UART0_BAUDRATE  115200                      // Macro for UART0 Baud rate
#define CENTER_POSITION 2571250                     // Macro for Center Position of Motor Shaft
